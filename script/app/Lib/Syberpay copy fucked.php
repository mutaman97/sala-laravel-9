...
class Syberpay {
    ...
    public static function make_payment($array)
    {
        ...
        //  Payment info here
        $paymentInfo = array('orderNo' => $orderId , 'customerName' => $customerName, 'paymentType' => $data['payment_type'], 'charge' => $charge, 'planId' => $plan_id, 'getwayId' => $getway_id, 'userId' => $user_id );
...
//  added by mutaman
       ...
       $paymentUrl = $result_array['paymentUrl'];
        ...
        Session::save('syberpay_credentials', $data);
  ...
  // end added
    ...
    public function notify(Request $request)
    {
        ...
        // Log::info($request);
        // dd($payment_data);
        $syberpayURL = $payment_data['syberpayURL'] . 'payment_status';
        $applicationId = $payment_data['applicationId'];
        $serviceId = $payment_data['serviceId'];
        $key = $payment_data['key'];
        // $payeeId = $payment_data['payeeId'];
