...
class PaymentgatewayController extends Controller
{
    ...
    public function uninstall($payment)
    {
        abort_if(!getpermission('payment_gateway'),401);
    ...
    public function store(Request $request,$id)
    {
       abort_if(!getpermission('payment_gateway'),401);
        ...
        return response()->json(__('Payment Gateway Successfully Updated'));
    ...
    public function custom_payment(Request $request)
    {
        ...
        return response()->json(__('Payment Gateway Successfully Created'));
    }
}
