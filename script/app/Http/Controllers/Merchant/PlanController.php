...
class PlanController extends Controller
{
    ...
    {
        Session::flash('message', __('Transaction Error Occured!'));
   ...
   public function changePlan($id)
    {
        ...
        $symbol=Option::where('key','currency_symbol')->first()->value ?? 'SDG';
   ...
   public function renewSuccess(Request $request)
   {
        ...
        //ordermeta
            ...
            if ($status == 1) {
              ...
              $this->tenantUpdate(Session::get('domain_data')['name'],$plan->duration,$order->id,$plan_info,$status);
   ...
   public function tenantUpdate($tenant_id,$duration,$order_id,$plan_info,$status)
   {
